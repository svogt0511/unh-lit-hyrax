Hyrax.config do |config|
  ...
  config.register_curation_concern :town_report
  ...
  #   maxFileSize: 500.gigabytes
  # }

  # Options to control the file uploader.  We are allowing 10GB but practically speaking
  # 1 GB or less is the most practical.
  config.uploader = {
    limitConcurrentUploads: 6,
    maxNumberOfFiles: 100,
  ...
  # NOTE: if you have always sent analytics to GA for downloads and page views
  ...
  config.derivatives_path = '/mnt/LocalDataStores/hyrax/tmp/derivatives'
  ...
  config.working_path = '/mnt/LocalDataStores/hyrax/tmp/uploads'
